...
const Wishlist = () => {
  ...
  const { all_products, listItems, removeFromList, url } =
  ...
  return (
    <section className="p-20 mt-10 pt-28">
      <table className="w-full mx-auto">
        <thead>
          <tr
            className="bg-slate-900/10 regular-18 sm:regular-22
                    text-start"
          >
                ...
                >
                  <td className="flexCenter">
                    <img
                      ...
                      height={43}
                      width={43}
                      className="rounded-lg rign-1 ring-slate-900/5 my-1"
                    />
                  </td>
                  <td>
